...
- `workspace` — workspace name.
- `worktree` — checkout directory name when the foreground process of the first tab's root pane runs inside a linked Git worktree; omitted on the primary checkout.
