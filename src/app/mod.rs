...
pub struct App {
    ...
    /// Git context per agent pane foreground cwd, refreshed with git status.
    pub(crate) agent_git_contexts: HashMap<std::path::PathBuf, crate::workspace::AgentGitContext>,
...
impl App {
    pub fn new(
        ...
        let mut app = Self {
            ...
            agent_git_contexts: HashMap::new(),
